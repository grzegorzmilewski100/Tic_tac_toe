...
class Board:
    ...
    def check_row(self, player, last_move):
        row_index = last_move.get_row()  # metoda zwraca nam ktory index rzedu wybralismy jako ostatni ruch
        board_row = self.game_board[row_index] # metoda ktora umożliwia wejscie do rzedu z porpzedniego ruchu

        return board_row.count(player.marker) == 3 # metoda ktora zwraca True jesli marker jest w 3 miejscach w rzedzie
